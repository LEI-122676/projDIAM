                            ...
                            <div className="event-metadata-row" style={{ 
                                ...
                                <div style={{ display: 'grid', gap: '12px' }}>
                                    ...
                                    <div className="form-group">
                                        ...
                                        <button type="button" className="btn-add-dashed" style= {{ width: '100%', height: '45px', color: '#4A3A31', display: 'flex', alignItems: 'center', justifyContent: 'center' }} onClick={handleAddAtividade}>
